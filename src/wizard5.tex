...
mapcar #'\nwlinkedidentc{describe-path}{NWNVxch-1p0Y9w-3}
\nwused{\\{NWNVxch-1p0Y9w-4}}\nwidentuses{\\{{\nwixident{describe-path}}{describe-path}}}\nwindexuse{\nwixident{describe-path}}{describe-path}{NWNVxch-3UGKyl-1}\nwendcode{}\nwbegindocs{33}\nwdocspar
...
\nwenddocs{}\nwbegincode{50}\sublabel{NWNVxch-4HI7rZ-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWNVxch-4HI7rZ-1}}}\moddef{Find the objects at the current location~{\nwtagstyle{}\subpageref{NWNVxch-4HI7rZ-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWNVxch-1p0Y9w-6}}\nwenddeflinemarkup
(\nwlinkedidentc{objects-at}{NWNVxch-1p0Y9w-5} loc objs obj-loc)
\nwused{\\{NWNVxch-1p0Y9w-6}}\nwidentuses{\\{{\nwixident{objects-at}}{objects-at}}}\nwindexuse{\nwixident{objects-at}}{objects-at}{NWNVxch-4HI7rZ-1}\nwendcode{}\nwbegindocs{51}\nwdocspar
...
\nwixlogsorted{c}{{Find the objects at the current location}{NWNVxch-4HI7rZ-1}{\nwixd{NWNVxch-4HI7rZ-1}\nwixu{NWNVxch-1p0Y9w-6}}}%
...
\inputminted[lastline=35]{lisp}{src/wizard5.lisp}
\newpage
\inputminted[firstline=38]{lisp}{src/wizard5.lisp}
