...
... or to the \lsp{attic} by going \lsp{upstairs} via the
\lsp{ladder}.
...
\noindent \lsp{downstairs} via the \lsp{ladder}.
...
With those symolic paths, we can
...
To describe a path, take the means (\gls{caddr}) and direction (\gls{cadr}) and
...
\inputminted[linenos,firstline=11,lastline=47]{lisp}{wizard5.lisp}
% \columnbreak
\newpage
\inputminted[linenos,firstline=50]{lisp}{wizard5.lisp}
% \end{multicols*}
% \restoregeometry
