...
\inputminted[linenos,firstline=11,lastline=51,fontsize=\footnotesize]{lisp}{src/wizard5.lisp}
\columnbreak
\inputminted[linenos,firstline=54,lastline=85,fontsize=\footnotesize]{lisp}{src/wizard5.lisp}
\end{multicols*}
\restoregeometry
