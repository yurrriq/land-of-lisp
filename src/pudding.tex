...
\nwenddocs{}\nwbegincode{2}\sublabel{NWlm77s-10gFhe-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlm77s-10gFhe-1}}}\moddef{src/pudding.lisp~{\nwtagstyle{}\subpageref{NWlm77s-10gFhe-1}}}\endmoddef\nwstartdeflinemarkup\nwprevnextdefs{\relax}{NWlm77s-10gFhe-2}\nwenddeflinemarkup
(defvar \nwlinkedidentc{*arch-enemy*}{NWlm77s-10gFhe-1} nil)\nwindexdefn{\nwixident{*arch-enemy*}}{*arch-enemy*}{NWlm77s-10gFhe-1}


\nwalsodefined{\\{NWlm77s-10gFhe-2}}\nwnotused{src/pudding.lisp}\nwidentdefs{\\{{\nwixident{*arch-enemy*}}{*arch-enemy*}}}\nwendcode{}\nwbegindocs{3}\nwdocspar
...
(setf \nwlinkedidentc{*arch-enemy*}{NWlm77s-10gFhe-1} 'useless-old-johnny)
...
\nwenddocs{}\nwbegincode{16}\sublabel{NWlm77s-10gFhe-2}\nwmargintag{{\nwtagstyle{}\subpageref{NWlm77s-10gFhe-2}}}\moddef{src/pudding.lisp~{\nwtagstyle{}\subpageref{NWlm77s-10gFhe-1}}}\plusendmoddef\nwstartdeflinemarkup\nwprevnextdefs{NWlm77s-10gFhe-1}{\relax}\nwenddeflinemarkup
(defun \nwlinkedidentc{pudding-eater}{NWlm77s-10gFhe-2} (person)\nwindexdefn{\nwixident{pudding-eater}}{pudding-eater}{NWlm77s-10gFhe-2}
  (case person
...
\nwixlogsorted{c}{{src/pudding.lisp}{NWlm77s-10gFhe-1}{\nwixd{NWlm77s-10gFhe-1}\nwixd{NWlm77s-10gFhe-2}}}%
\nwixlogsorted{i}{{\nwixident{*arch-enemy*}}{*arch-enemy*}}%
\nwixlogsorted{i}{{\nwixident{pudding-eater}}{pudding-eater}}%
\nwbegindocs{17}\nwdocspar
...
{\Tt{}\LA{}src/pudding.lisp~{\nwtagstyle{}\subpageref{NWlm77s-10gFhe-1}}\RA{}\nwendquote}:
\inputminted{lisp}{src/pudding.lisp}

\section{Example Session}

After loading {\Tt{}\LA{}src/pudding.lisp~{\nwtagstyle{}\subpageref{NWlm77s-10gFhe-1}}\RA{}\nwendquote}, you might have a session like this:
