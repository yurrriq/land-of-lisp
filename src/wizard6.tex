...
\nwalsodefined{\\{NWOFbi8-1p0Y9w-2}\\{NWOFbi8-1p0Y9w-3}\\{NWOFbi8-1p0Y9w-4}\\{NWOFbi8-1p0Y9w-5}\\{NWOFbi8-1p0Y9w-6}\\{NWOFbi8-1p0Y9w-7}}\nwnotused{*}\nwidentdefs{\\{{\nwixident{lol.wizard6}}{lol.wizard6}}}\nwendcode{}\nwbegindocs{3}\end{marginfigure}
...
\nwenddocs{}\nwbegincode{28}\sublabel{NWOFbi8-1p0Y9w-7}\nwmargintag{{\nwtagstyle{}\subpageref{NWOFbi8-1p0Y9w-7}}}\moddef{*~{\nwtagstyle{}\subpageref{NWOFbi8-1p0Y9w-1}}}\plusendmoddef\nwstartdeflinemarkup\nwprevnextdefs{NWOFbi8-1p0Y9w-6}{\relax}\nwenddeflinemarkup
(export (find-symbol "GAME-REPL"))
\nwendcode{}\nwbegindocs{29}\nwdocspar

\section{Tests}

\nwenddocs{}\nwbegincode{30}\sublabel{NWOFbi8-2hXnLe-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWOFbi8-2hXnLe-1}}}\moddef{test/wizard5.lisp~{\nwtagstyle{}\subpageref{NWOFbi8-2hXnLe-1}}}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
(in-package :lol.wizard5)
...
\nwixlogsorted{c}{{test/wizard5.lisp}{NWOFbi8-2hXnLe-1}{\nwixd{NWOFbi8-2hXnLe-1}}}%
\nwixlogsorted{i}{{\nwixident{*allowed-commands*}}{*allowed-commands*}}%
\nwixlogsorted{i}{{\nwixident{game-eval}}{game-eval}}%
\nwixlogsorted{i}{{\nwixident{game-print}}{game-print}}%
\nwixlogsorted{i}{{\nwixident{game-read}}{game-read}}%
